...
>) {
  ...
  const movingMap: Record<Direction, string> = {
    TOP: "radial-gradient(20.7% 50% at 50% 0%, #5d8e81 0%, rgba(113, 162, 149, 0) 100%)",
    LEFT: "radial-gradient(16.6% 43.1% at 0% 50%, #5d8e81 0%, rgba(113, 162, 149, 0) 100%)",
    BOTTOM:
      "radial-gradient(20.7% 50% at 50% 100%, #5d8e81 0%, rgba(113, 162, 149, 0) 100%)",
    RIGHT:
      "radial-gradient(16.2% 41.2% at 100% 50%, #5d8e81 0%, rgba(113, 162, 149, 0) 100%)",
  };

  const highlight =
    "radial-gradient(75% 181.15% at 50% 50%, #3f7d6e 0%, rgba(130, 192, 176, 0) 100%)";
